        ...
        <div class="bgded overlay row4" style="background-image:url('images/viajes-y-expediciones_cuadrada.jpg');">
            <footer id="footer" class="hoc clear"> 
                <div class="one_quarter">
                    <h5 class="heading"> Gestion Servicios </h5>
                    <form action="SvServicio" method="POST">
                        ...
                        <fieldset>
                            ...
                            <input type="text" class="btmspace-15" name="descrip" placeholder="Descripción">

                            <input type="text" class="btmspace-15"   name="destino" placeholder="Destino">

                            <input type="text" class="btmspace-15"  name="fecha" placeholder="Fecha">

                            <input type="number" class="btmspace-15"   name="costo" placeholder="Costo">



                            <button type="submit" class="btn btn-primary">Crear</button> 
                            <br></br>
                            <a class="btn" href="MostrarServicios.jsp">Mostrar Servicios</a> 
